...
import { sendTelegramMessage, telegramMessageInputSchema } from "@hardik2004s/sendkit-core";
...
function protectedResourceMetadataUrl(c: Context, botToken: string) {
  return new URL(`/.well-known/outh-protected-resource/${botToken}/mcp`, c.req.url).toString();
}
